...
setType("Main.Actions", Actions);
function update(model, action) {
  return action.Fields[0];
}
function view(model) {
  return Tags.div(ofArray([Attributes.classy("columns is-flex-mobile")]))(ofArray([Tags.div(ofArray([Attributes.classy("column")]))(new List$1()), Tags.div(ofArray([Attributes.classy("column is-narrow is-narrow-mobile"), new Types.Attribute("Style", [ofArray([["width", "400px"]])])]))(ofArray([Tags.label(ofArray([Attributes.classy("label")]))(ofArray([Tags.text("Enter your name:")])), Tags.p(ofArray([Attributes.classy("control")]))(ofArray([Tags.input(ofArray([Attributes.classy("input"), Attributes.property("type", "text"), Attributes.property("placeholder", "Ex: Joe Doe"), Attributes.property("value", model), VDom.onInput(function (arg0) {
    return new Actions("ChangeStr", [arg0]);
  })]))])), Tags.span(new List$1())(ofArray([Tags.text(fsFormat("Hello %s")(function (x) {
    return x;
  })(model))]))])), Tags.div(ofArray([Attributes.classy("column")]))(new List$1())]));
}
AppApi.start(AppApi.withStartNodeSelector("#main", AppApi.createSimpleApp("", function (model) {
  return view(model);
}, function (model) {
...
}((this.main = this.main || {}),virtualDom));
